...
namespace CyclopsDockingMod
{
	public class BasePart
    {
        ...
        public static readonly Vector3 P_CyclopsDockingHatchC = new Vector3(0f, BasePart.P_CyclopsDockingHatch.y + 0.4f, 0f);

        public static readonly Vector3 P_CyclopsDockingHatchCF = new Vector3(0f, BasePart.P_CyclopsDockingHatch.y - 0.3f, 0f);

        public static readonly Vector3 P_CyclopsDockingHatchF = new Vector3(0f, BasePart.P_CyclopsDockingHatch.y + 2f, 0f);
		...
		{
			return FastHelper.IsNear(pos, this.position - BasePart.P_CyclopsDockingHatchC);
		}
	}
}
